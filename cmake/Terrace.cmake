...
macro(TerracePipelineSetupNames)
  set(PIPELINE_NAME "Terrace")
  string(TOUPPER "${PIPELINE_NAME}" PIPELINE_NAME_UPPER)
  set(PIPELINE_INSTALL_TARGET "${PIPELINE_NAME}-install")
endmacro()

macro(TerracePipelineSetup)
  TerracePipelineSetupNames()
...
TerracePipelineSetup()

#

function(TerracePipeline)
  TerracePipelineSetupNames()
  ...
  InstallTerraceLLVMIRPipeline(DEPENDS ${PIPELINE_PREFIX}_link DESTINATION .)
endfunction()


function(InstallTerraceLLVMIRPipeline)
  TerracePipelineSetupNames()
